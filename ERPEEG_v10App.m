classdef ERPEEG_v10App < handle
    ...
    properties (Constant)
        AppPathBase = {'/ERPEEG_v10/code'};
        AppClass = 'ERPEEG_v10App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            ERPEEG_v10App.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'ERP_main')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong ERP_main
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'ERP_main').getString, ...
            ...
            if nargout(@ERP_main) == 0
                eval('ERP_main');
            else
                obj.AppHandle = eval('ERP_main');
            end
