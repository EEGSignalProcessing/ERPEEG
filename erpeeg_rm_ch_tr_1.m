...
% erpeeg_rm_ch_tr_1() - displays epoched ERPEEG data.
% 
% Inputs:   A        - parent GUI structure
%           step_num - step of erpeeg_rm_ch_tr_1 in workflow
...
function erpeeg_rm_ch_tr_1(A, step_num)
