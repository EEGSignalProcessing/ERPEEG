...
% erpeeg_settings() - User-adjustable variables for use in ERPEEG toolbox.
% 
...
if isempty(answer) %Cancel Button
    ...
    switch choice %Change Settings
        case 'Yes'
            ...
            erpeeg_reset_workflow(S,1,S.num_steps)
    end
...
if isempty(answer) %Cancel Button
    ...
    switch choice
        case 'Yes' %Change settings
            ...
            erpeeg_reset_workflow(S,2,S.num_steps)
    end
...
if isempty(answer) %Cancel Button
    ...
    switch choice
        case 'Yes' %Update Settings
            ...
            erpeeg_reset_workflow(S,4, S.num_steps)
    end
...
if isempty(answer) %Cancel Button
    ...
    switch choice
        case 'Yes' %Change Settings
            ...
            erpeeg_reset_workflow(S,5,S.num_steps)
    end
...
if isempty(answer) %Cancel Button
    ...
    switch choice
        case 'Yes' %Change Settings
            ...
            erpeeg_reset_workflow(S,6,S.num_steps)
    end
