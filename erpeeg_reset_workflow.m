function [] = erpeeg_reset_workflow(S, fromstep, tostep)
% erpeeg_reset_workflow() - resets the workflow by deleting future
...
if exist([basepath '/' basefile '_erpeeg_settings.mat'],'file')
    delete([basepath '/*' basefile '_erpeeg_settings.mat'])
end
